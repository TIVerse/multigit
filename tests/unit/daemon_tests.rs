...
fn test_daemon_service_creation() {
    ...
    assert_eq!(std::mem::size_of_val(&service), std::mem::size_of::<DaemonService>());
}
...
fn test_schedule_creation() {
    ...
    assert_eq!(std::mem::size_of_val(&seconds_schedule), std::mem::size_of::<Schedule>());
    
    // Test every_minutes
    let minutes_schedule = Schedule::every_minutes(5);
    assert_eq!(std::mem::size_of_val(&minutes_schedule), std::mem::size_of::<Schedule>());
}
...
fn test_daemon_config_validation() {
    ...
    assert_eq!(std::mem::size_of_val(&service2), std::mem::size_of::<DaemonService>());
}
...
fn test_scheduler_interval() {
    ...
    assert_eq!(std::mem::size_of_val(&scheduler), std::mem::size_of::<Scheduler>());
}
